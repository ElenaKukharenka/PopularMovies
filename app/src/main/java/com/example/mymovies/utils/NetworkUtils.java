...
public class NetworkUtils {
    ...
    private static final String API_KEY = "ff0e34788cecb85d58cc3e65286a983a";
    ...
    public static URL urlBuildToVideos (int id, String lang){
    ...
    public static URL urlBuildToReviews (int id, String lang){
    ...
    public static JSONObject getJSONForVideos(int id, String lang){
        ...
        JSONObject result = null;
        URL url = urlBuildToVideos(id, lang);
        try {
            result = new  JSONLoadTask().execute(url).get();
        } catch (ExecutionException e) {
            e.printStackTrace();
    ...
    public static JSONObject getJSONForReviews(int id, String lang){
        ...
        JSONObject result = null;
        URL url = urlBuildToReviews(id, lang);
        try {
            result = new  JSONLoadTask().execute(url).get();
        } catch (ExecutionException e) {
            e.printStackTrace();
